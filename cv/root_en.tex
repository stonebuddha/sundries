...
\extrainfo{Peking University -- School of Computer Science -- Assistant Professor}                 % optional, remove / comment the line if not wanted
...
\bibliographyjour{publications}                 % 'publications' is the name of a BibTeX file
\vspace{4pt}
