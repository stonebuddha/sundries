...
I am a Ph.D. student at Carnegie Mellon University working with Jan Hoffmann.
%
...
\begin{itemize}
  \item{\cventry{Aug 2017 -- present}{Ph.D. in Computer Science \emph{(GPA: 4.0/4.0)}}{Carnegie Mellon University}{Pittsburgh, PA, USA}{}{Advisor: Prof. Jan Hoffmann \\ Thesis: \emph{Static Analysis of Probabilistic Programs: An Algebraic Approach}}}

  \vspace{4pt}

  \item{\cventry{Sep 2013 -- Jun 2017}{Bachelor of Science (with Honors) in Computer Science \& Technology \emph{(GPA: 3.83/4.0)}}{Peking University}{Beijing, China}{}{Advisor: Prof. Yingfei Xiong \\ Thesis: \emph{Accelerating Program Analyses by Conditional Summarization with Datalog}}}
\end{itemize}
...
%  \vspace{4pt}
  ...
  \item{\cventry{May 2020 -- Aug 2020}{Research intern, supervised by Dr. Herman Venter}{Facebook Novi}{Seattle, WA, USA}{}
  {Topics: Formal Verification of Rust Code, Side Channel Analysis of Blockchain Code}}

  \vspace{4pt}

  \item{\cventry{Sep 2016 -- Jan 2017}{Research intern, supervised by Prof. Adam Chlipala}{Massachusetts Institute of Technology}{Boston, MA, USA}{}
  {Topics: Type System for Complexity Analysis, Complexity Preserved Compiler}}

  \vspace{4pt}

  \item{\cventry{Jun 2016 -- Aug 2016}{Research intern, supervised by Prof. Thomas Reps}{University of Wisconsin-Madison}{Madison, WI, USA}{}
...
\begin{itemize}
  ...
  \item \textbf{External Reviewer} -- ICALP'18, LICS'19, LICS'20, LICS'21, ESOP'20, ESOP'21, POPL'21
\end{itemize}
...
\begin{itemize}
  \item \textbf{Sound Probabilistic Inference via Guide Types}, \emph{PLDI'21}. \hfill Jun 2021
  \item \textbf{Central Moment Analysis for Cost Accumulators in Probabilistic Programs}, \emph{PLDI'21}. \hfill Jun 2021
  \item \textbf{Raising Expectations: Automating Expected Cost Analysis with Types}, \emph{ICFP'20}. \hfill Aug 2020
  \item \textbf{Liquid Resource Types}, \emph{ICFP'20}. \hfill Aug 2020
  \item \textbf{A Denotational Semantics for Low-Level Probabilistic Programs with Nondeterminism}, \emph{MFPS'19}. \hfill Jun 2019
  \item \textbf{Type-Guided Worst-Case Input Generation}, \emph{POPL'19}. \hfill Jan 2019
  \item \textbf{PMAF: An Algebraic Framework for Static Analysis of Probabilistic Programs}, \emph{PLDI'18}. \hfill Jun 2018
\end{itemize}

\subsection{Seminar Presentations}

\begin{itemize}
  \item \textbf{Type-Based Resource-Guided Search}, \emph{Peking University}, Programming Language Seminar. \hfill Oct 2020
  \item \textbf{Taint Analysis for Blockchain Code}, \emph{Facebook Novi}, Novice Seminar. \hfill Aug 2020
  \item \textbf{Automating Expected Cost Analysis with Types}, \emph{Facebook Novi}, Novice Seminar. \hfill Jun 2020
\end{itemize}

\section{Projects}

\begin{itemize}
  \item{\cventry{May 2020 -- Aug 2020}{Research Intern at Facebook}{Static Tag Analysis of Rust Code}{}{}{
      \begin{itemize}
  ...
  \item{\cventry{April 2018 -- May 2018}{Graduate Artificial Intelligence}{Predicting the Efficiency of Exact Inference Methods in Bayesian Network}{}{Carnegie Mellon University}{
        \begin{itemize}
