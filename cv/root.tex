...
\usepackage{multibib}
\newcites{conf,jour,thesis}{{Refereed Conference Papers},{Refereed Journal Papers},{Other Publications}}
%----------------------------------------------------------------------------------
%            content
%----------------------------------------------------------------------------------
\begin{document}
...
\nociteconf{OOPSLA:LW25,OOPSLA:PWS24,OOPSLA:GCY24,ECOOP:PWS24,OOPSLA:WR24,POPL:DWH23,PLDI:WHR21B,PLDI:WHR21A,ICFP:KWR20,ICFP:WKH20,PLDI:KWP19,MFPS:WHR19,POPL:WH19,PLDI:WHR18,OOPSLA:WWC17,ESOP:TWX17}
\bibliographystyleconf{unsrt}
\bibliographyconf{publications}                   % 'publications' is the name of a BibTeX file
\vspace{4pt}
\nocitejour{TOPLAS:JZX24}
\bibliographystylejour{unsrt}
\bibliographyjour{publications}
\vspace{4pt}
\nocitethesis{arxiv:CWW24,arxiv:HW24,arxiv:WW23,arxiv:WHR21}
