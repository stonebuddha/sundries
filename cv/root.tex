...
%\begin{itemize}
  {\cventry{Aug 2017 -- present}{Ph.D. in Computer Science \emph{(GPA: 4.0/4.0)}}{Carnegie Mellon University}{Pittsburgh, PA, USA}{}{Advisor: Prof.\ Jan Hoffmann \\ Thesis: \emph{Static Analysis of Probabilistic Programs: An Algebraic Approach}}}

  \vspace{4pt}

  {\cventry{Sep 2013 -- Jun 2017}{Bachelor of Science (with Honors) in Computer Science \& Technology \emph{(GPA: 3.83/4.0)}}{Peking University}{Beijing, China}{}{Advisor: Prof.\ Yingfei Xiong \\ Thesis: \emph{Accelerating Program Analyses by Conditional Summarization with Datalog}}}
%\end{itemize}
