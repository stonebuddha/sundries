...
you should place your code here."
  (let ((path (shell-command-to-string "eval `opam config env`; echo -n $PATH")))
    (setenv "PATH" path)
    (setq exec-path
          (append
  ...
  (dolist (ft (fontset-list))
    (set-fontset-font ft 'unicode (font-spec :name "mononoki Nerd Font" :size 14))
    (set-fontset-font ft 'unicode (font-spec :name "XITS Math monospacified for mononoki Nerd Font") nil 'append))
  ...
  (spacemacs/set-leader-keys (kbd ",") 'unhighlight)
